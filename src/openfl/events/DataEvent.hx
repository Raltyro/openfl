...
class DataEvent extends TextEvent
{
	...
	**/
	public static var DATA(default, never):EventType<DataEvent> = "data";
	...
	**/
	public static var UPLOAD_COMPLETE_DATA(default, never):EventType<DataEvent> = "uploadCompleteData";
